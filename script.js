...
function translateDocument() {
    ...
    const translations = {
        ...
        jp: {
            ...
            tr_long: "私はデータネットワークとクールなプロジェクトに興味がある情熱家です。現在、ノースロップ・グラマンで電気工エンジニアとして働いており、スケーラブルで堅牢なネットワーク・アーキテクチャとアプリケーションの設計で貴重な経験を積んでいます。自由時間には、ビデオゲームや日本のオルタナロックの作曲を楽しんでいます。",
            tr_explore: "私の",
